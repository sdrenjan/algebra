let car = {
    ...
    consumption: function() {
        if (this.engine.fuel == 'diesel') {
            return `${this.name} ${this.model} with ${this.engine.fuel} engine consumes < 5L/100km`;
        } else {
    ...
    family: function() {
        if (this.doors > 3) {
            ...
            return `${this.name} ${this.model} is not suitable for families because it does not have 5 doors`;
        }
    },
